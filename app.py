...
# a 10 x 12 rectangle (search seed 19), so a perfect packing exists:
# total area 120, optimum L = 12 at 100% efficiency. Four identical
# groups keep the identical-rectangle ordering constraints active out of
# the box. Gurobi + Big-M proves optimality in ~42 s on a workstation —
# within the 60 s cap — while HiGHS at the default 10 s leaves a visible
# gap, so the solver comparison has a story on first Solve.
DEFAULT_DATA = {
    "rects": list(range(1, 16)),
    "w": {1: 5.0, 2: 4.0, 3: 4.0, 4: 4.0, 5: 4.0, 6: 4.0, 7: 4.0,
          8: 3.0, 9: 3.0, 10: 3.0, 11: 2.0, 12: 2.0, 13: 2.0,
          14: 1.0, 15: 1.0},
    "length": {1: 2.0, 2: 3.0, 3: 2.0, 4: 2.0, 5: 2.0, 6: 2.0, 7: 1.0,
               8: 4.0, 9: 4.0, 10: 2.0, 11: 5.0, 12: 5.0, 13: 2.0,
               14: 4.0, 15: 4.0},
    "W": 10.0,
}
